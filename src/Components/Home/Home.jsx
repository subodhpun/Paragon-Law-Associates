...
export const RangeOfPractice= ()=>{
  ...
  <div className="practiceAreasDes">
    ...
    <div className="practiceAreasDesMain">
      ...
      <div className="LawImg">
        <Link to="/CyberLaw">
      <img src='src\assets\practiceareas\cyberLaw.png' alt='no'/>
      </Link>
        </div>
        <div className="LawDes">
      ...
      <div className="practiceAreasDiv">
      <div className="LawImg">
        <a href='#'><img src='src\assets\practiceareas\taxLaw.jpg' alt='no'/></a>
        </div>
        <div className="LawDes">
      ...
      <div className="practiceAreasDiv">
      <div className="LawImg">
        <a href='#'><img src='src\assets\practiceareas\energyLaw.jpg' alt='no'/></a>
        </div>
        <div className="LawDes">
      ...
      <div className="practiceAreasDiv">
      <div className="LawImg">
        <a href='#'><img src='src\assets\practiceareas\labourLaw.jpg' alt='no'/></a>
        </div>
        <div className="LawDes">
    ...
    <RangeOfPractice/>
      ...
      <div className="members">
        ...
        <div className="gaurabDangi">
          ...
          <div className="desForGaurab">
            ...
            <a href='tel:9823520190' target='_blank'>
              <h3><img src='src\assets\photos\phoneIcon.png' alt='phone icon' className='phonegmailIcon'/>
              9823520190</h3></a>
         <a href='mailto:subodhmagar07@gmail.com'>
          <h3><img src='src\assets\photos\gmailIcon.png' alt='phone icon' className='phonegmailIcon'/>
        ...
        <div className="bibekMainali">
          ...
          <a href='https://www.facebook.com/bibek.mainali.7' target='_blank'><img src="src\assets\photos\bibekMainali.png" alt="No Image" /></a>
          </div>
        ...
        <div className="otherMembers">
          <div className="member1">
            ...
            <img src='src\assets\photos\balKrishna.png' alt='no'/>
            </div>
         ...
         <a href='mailto:subodhmagar07@gmail.com'>
          ...
          <div className="member2">
            ...
            <img src='src\assets\photos\kiran.png' alt='no'/>
            </div>
         ...
         <a href='mailto:subodhmagar07@gmail.com'>
          ...
          <div className="member3">
            ...
            <img src='src\assets\photos\sunil.png' alt='no'/>
            </div>
